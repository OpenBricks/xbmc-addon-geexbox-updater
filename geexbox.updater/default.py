...
class MyClass(xbmcgui.WindowDialog):
  ...
  def __init__(self):
    ...
    self.strActionInfo = xbmcgui.ControlLabel(larg + deltax, 3*deltay, 500, ep*2, 'GeeXboX packages', 'font24_title', '0xFFFF000F')
    self.addControl(self.strActionInfo)
    self.button0 = xbmcgui.ControlButton(3*deltax, 10*deltay, 250, ep, "Upgrade packages ...")
    self.addControl(self.button0)
    self.button1 = xbmcgui.ControlButton(3*deltax, 15*deltay, 250, ep, "Add a package ...")
    self.addControl(self.button1)
    self.button2 = xbmcgui.ControlButton(3*deltax, 20*deltay, 250, ep, "Remove a package ...")
    self.addControl(self.button2)
    self.button3 = xbmcgui.ControlButton(3*deltax, 25*deltay, 250, ep, "Exit")
    self.addControl(self.button3)
    self.button4 = xbmcgui.ControlButton(4*deltax, 15*deltay, 100, ep, "Options")
    self.addControl(self.button4)
    self.button5 = xbmcgui.ControlButton(4*deltax, 20*deltay, 200, ep, choosenRepo)
    self.addControl(self.button5)
    self.stropt1 = xbmcgui.ControlLabel(4*deltax, 14*deltay, 300, ep, 'Options for opkg :', 'font10', '0xFFBBFFBB')
    self.addControl(self.stropt1)
    self.strFrom = xbmcgui.ControlLabel(4*deltax, 19*deltay, 300, ep, 'Binary location :', 'font10', '0xFFBBFFBB')
    self.addControl(self.strFrom)
    self.strActionRemove = xbmcgui.ControlLabel(larg + 2 * deltax, 6 * deltay, 400, ep, 'Select Package to remove', 'font18', '0xFFBBFFBB')
    self.addControl(self.strActionRemove)
    self.strActionAdd = xbmcgui.ControlLabel(larg + 2 * deltax, 6 * deltay, 400, ep, 'Select Package to add ...', 'font18', '0xFFBBFFBB')
    ...
    self.buttonexitR = xbmcgui.ControlButton(4*deltax, 25*deltay, 100, ep, "Exit")
    self.addControl(self.buttonexitR)
    self.buttonexitA = xbmcgui.ControlButton(4*deltax, 25*deltay, 100, ep, "Exit")
    ...
    self.buttontext = xbmcgui.ControlButton(screenx - 10*deltax, screeny - 10*deltay, 200, ep, 'Close')
